...
// Single glass testimonial card. Renders the attribution row (photo, name,
// company) only when provided — some quotes ship without attribution.
function TestimonialCard({ testimonial }) {
  const hasAttribution = Boolean(testimonial.name);
